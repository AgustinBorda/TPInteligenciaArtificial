...
# InstrumentedProblem doesn't work with bidirectional approaches, so
# we instrument the algorithm, this returns a tuple with the result and the explored nodes.
def instrumented_bidirectional_breadth_first_search(problem, inverse_problem, explored_nodes=False):
